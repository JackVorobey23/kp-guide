...
## Теорія ймовірностей [[↑]](#другий-курс)
...
Буде 8 практик, розрахунково-графічна робота (6 завдань з практик) та модульна контрольна робота (2 завдання з практик). 
...
## Компоненти програмної інженерії 2. Моделювання ПЗ [[↑]](#другий-курс)
...
Цей стартап повинен сподобатися обом викладачам (див. нижче). Були випадки, коли один з них затверджував стартап, а потім інший при перевірці декількох лабораторних казав створити нову ідею та зробити все спочатку.
...
Лабораторні роботи оцінюються дуже суб'єктивно, дуже залежить хто перевіряє - Люшенко чи Струцинський. РСО: 10 за ідею стратапу, кожна лаба по 10 балів, буде 7 лаб (5, 6, 7 як одна на 30 балів) + 20 балів презентація.
...
Оцінює все суб'єктивно та хаотично, але зазвичай дуже низькі бали не ставить.

### Лектор і практик - Струцинський Олексій Анатолійович
Великий бізнесмен та важлива людина у "Sikorsky Challenge". Оцінює рандомно, але не прям жахливо.

<a id="gdk"></a>

## Групова динаміка і комунікації [[↑]](#другий-курс)
...
Загалом буде десь 7 домашніх завдань: накидати ідеї стартапів, презентація про техніки креативного мислення, створення мети та SMART-цілей, різних діаграм, резюме тощо. Ну і невеличка МРК наостанок.
...
## Математичний аналіз (МАТАН) [[↑]](#другий-курс)
...
Найскладніший предмет всього курсу (він буде у обох семестрах). У першому семестрі 3 розрахункових та 3 модульних контрольних, у другому - 2 та 6 відповідно. Як їх писати? Дізнайтесь самі!

### Лекторка, практик, легенда - Легеза Віктор Петрович
Про людину є [стаття](https://uk.wikipedia.org/wiki/Легеза_Віктор_Петрович) на Вікіпедії, що ще треба?

Віктор Петрович після війни перестав проводити іспити та просто робить перерахунок (максимум 50 балів за семестр, вони множаться на 2). Тим, кому зовсім трохи не вистачає до 60 балів, він влаштовує додаткові добори балів.

<a id="db"></a>

## Бази даних [[↑]](#другий-курс)
...
Предмет не важкий, але дуже потрібний. Будете працювати з PostgreSQL, вивчати бази даних в цілому, їх типи, історію і тому подібне. Викладається все ясно та зрозуміло.

Буде 6 лаб по 6 балів, ще 14 балів за тест на парі, виходить 50. Замість іспиту подвоюють. Можна зарбити додаткові бали за відвідування пар і відповіді на них. Також можна заробити додаткові бали за різні курси про БД, про це треба домовлятись з викладачкою. 
...
Дуже добра, відноситься з повагою і вимагає її від студентів. На запитання студентів відповідає нормально, матеріал знає (хоча іноді в її матеріалах трапляються помилки і за їх знаходження вона дає додаткові бали).
 ...
 ### Про курсову роботу
У третьому семестрі з цієї дисципліни курсова робота - це просто поєднання всіх лабораторних в одній, ну і звіт до цього всього оформити. До оформлення докопується, тому треба уважно робити. Загалом дуже просто робиться, легкі 100 балів.

<a id="oop"></a>

## Програмування (ООП) [[↑]](#другий-курс)
...
Сама курсова полягає у написанні програми з використанням 7 проєктувальних шаблонів. Заболотня підкаже з вибором тем та у квітні-травні буде проводити додаткові консультації, якщо щось незрозуміло. 

Якась мега супер програма з графічним інтерфейсом не вимагається, достатньо і консольного. Головне - обгрунтоване використання 7 або більше патернів проєктування. Ну і документація: план-графік, завдання, технічне завдання, пояснювальна записка (там теж багато не вимагається).

Порада не відкладати все до останнього моменту, бо може не вистачити часу. Курсач можна починати здавати ще у квітні, а закінчується здача після початку червня.

<a id="choice1"></a>

## Вибірковий предмет (3 семестр) [[↑]](#другий-курс)
...
## Компоненти програмної інженерії 3. Архітектура ПЗ [[↑]](#другий-курс)
...
Буде 6 лабораторних по 10 балів та модульна контрольна на 40 балів. На жаль, іноді у вимогах до лаби буде написано одне, а на захисті вимагатись буде зовсім інше. Завдання до окремих лаб взагалі передбачають самостійне вивчення 100500 матеріалів без пояснень викладачів, тому не все так весело.
...
## Програмування (веб і андроїд)[[↑]](#другий-курс)
...
## Філософські основи наукового пізнання[[↑]](#другий-курс)
...
На пари з філософії було бажання заходити, бо можна почілити і пороздумувати на різні теми, подискутувати з викладачем. Раджу хоча б пару разів сходити на пари.
...
## Алгоритмічне забезпечення мультимедійних та інформаційно-пошукових систем[[↑]](#другий-курс)
...
Буде дві МКР по 15 балів. Не сказати, що складні, але кожна дрібна помилка буде впливати на загальний бал. Також буде дві величезних лабораторних по 10 балів (але можна ризикнути і спробувати отримати +2 бала, ну або -2). Більшість людей навіть не робить ці лабораторні, а другу так взагалі лише одиниці. Якщо не можеш щось пояснити в лабі, то Онай просто каже здати наступного разу, менше 6 балів він не ставить. Після квітня Онай взагалі не приймає роботи, можливо, лише наприкінці всього семестру.
...
## Комп'ютерна логіка [[↑]](#другий-курс)
...
### Лектор - Дичка Іван Андрійович
 Декан факультету. Викладає зрозуміло, надсилає додаткові матеріали для підготовки до контрольних на пошту, ніяких проблем з ним не виникало.

<a id="choice2"></a>

## Вибірковий предмет (4 семестр) [[↑]](#другий-курс)
